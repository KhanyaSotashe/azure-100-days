# Day 9: Project Overview

Today I was tasked with attaching a Network Interface Card disk to an existing Virtual Machine

## Key Learnings
* **Network Integration:** Successfully created and attached a Network Interface Card (NIC) to an Azure Virtual Machine to establish essential cloud connectivity.
* **Resource Linking:** Gained hands-on experience bridging compute and networking infrastructure by properly associating the NIC with a designated Virtual Network (VNet) and subnet.
* **Interface Management:** Solidified my understanding of how Azure handles IP configurations and routing at the network interface level to control traffic flow.
